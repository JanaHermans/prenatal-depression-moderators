...
#------------------------------PRE-PREG DEPRESSION------------------------------
filename_ALSPAC <- "res_prepregdep_imputed_ALSPAC2026-07-21.RData"
...
filename_ALSPAC <- "res_continuous_imputed_ALSPAC2026-07-21.RData"
...
filename_ALSPAC <- "res_completecases_ALSPAC2026-07-21.RData"
filename_GenR <- "res_completecases_GenR2026-07-21.RData"
ALSPAC_file <- readRDS(file.path(results_path,filename_ALSPAC))
GenR_file <- readRDS(file.path(results_path,filename_GenR))
...
#--------------------------------WITHOUT OUTLIERS-------------------------------
filename_ALSPAC <- "res_outliers_ALSPAC2026-07-21.RData"
...
#----------------------------------50% ELS DATA---------------------------------
filename_ALSPAC <- "res_50ELS_ALSPAC2026-07-21.RData"
filename_GenR <- "res_50ELS_GenR2026-02-19.RData"
ALSPAC_file <- readRDS(file.path(results_path,filename_ALSPAC))
GenR_file <- readRDS(file.path(results_path,filename_GenR))
...
write_combined_results_to_word(results_list, paste0(outdir,"STable_50ELS.docx"),
                               moderators)
