########################################################################
# Title:    Quality check of imputation (ALSPAC)
# Author:   Jana Hermans
...
libraries <- c("haven","dplyr","mice","ggplot2","grid","gridExtra","lattice")
...
pdf('V:/medewerkers/093307 Hermans A.P.C/project_3/QC-imputation_project3_rf_ALSPAC.pdf')
